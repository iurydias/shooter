...
public class CanvasPanelImage extends JPanel implements Runnable {
        ...
        while (play) {
            ...
            if (player.isAlive) {
                for (int i = 0; i < numberOfEnemies; i++) {
                    ...
                    if (enemy[i].enemytype == 1 || enemy[i].enemytype == 2 || enemy[i].enemytype == 6) {
                    ...
                    if (enemy[i].enemytype == 5) {
                        ...
                        if (enemy[i].x > 650 && enemy[i].movement == 3) {
                            enemy[i].movement = 4;
                        }
                        if (enemy[i].y > 400 && enemy[i].movement == 3) {
                            enemy[i].movement = 4;
                        }
                        if (enemy[i].y > 400 && enemy[i].movement == 4) {
                            enemy[i].movement = 5;
                        }
                    ...
                    if (enemy[i].isAlive && remainingHearts != 0
                        ...
                        if (!hitted) {
                            if (enemy[i].enemytype == 1 || enemy[i].enemytype == 2 || enemy[i].enemytype == 3
                                    || enemy[i].enemytype == 4 || enemy[i].enemytype == 6) {
                        ...
                        if (enemy[v].isAlive) {
                            if (enemy[v].getBounds().intersects(bullets1[i].getBounds())) {
                                ...
                                if (enemy[v].enemylife <= 0) {
                                    ...
                                    } else if (enemy[v].enemytype == 6) {
                                        score += 350 + bonusScore;
                        ...
                        for (int v = 0; v < numberOfEnemies; v++) {
                            if (enemy[v].isAlive) {
                                if (enemy[v].getBounds().intersects(shotmissiles[i].getBounds())) {
                                    if (enemy[v].enemytype == 1 || enemy[v].enemytype == 2 || enemy[v].enemytype == 3
                                            || enemy[v].enemytype == 4 || enemy[v].enemytype == 6) {
                                        if (enemy[v].enemytype == 1) {
                                            score += 10;
                                            verif = false;
    ...
    public void addEnemyBullet(Enemy sEnemy) {
        for (int i = 0; i < numberOfEnemyBullets; i++) {
            if (!bullets1[i].fired && (sEnemy.enemytype == 2 || sEnemy.enemytype == 4 || sEnemy.enemytype == 6)) {
    ...
    public void reset(int level, boolean first) {
        ...
        for (int i = 0; i < numberOfEnemies; i++) {
            ...
            if (enemy[i].enemytype == 1 || enemy[i].enemytype == 2) {
                ...
                enemy[i].enemylife = 5;
            } else if (enemy[i].enemytype == 6) {
                enemy[i].enemylife = 6;
            } else {
                enemy[i].enemylife = 50 + bossLife;
            }
